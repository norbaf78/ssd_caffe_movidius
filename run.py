...
def main():
    ...
    # point to the camera
    video_capture=cv2.VideoCapture("http://root:progtrl01@192.168.208.200/mjpg/1/video.mjpg")
    ...
    while True:  # fps._numFrames < 120
        ...
        resized_image = cv2.resize(frame_camera,  (int(frame_camera.shape[1]/2), int(frame_camera.shape[0]/2)))
